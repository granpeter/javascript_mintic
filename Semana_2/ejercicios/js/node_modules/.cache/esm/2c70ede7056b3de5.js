let tripulantes;_056‍.x([["busquedaPorId",()=>busquedaPorId],["busquedaPorSalario",()=>busquedaPorSalario]]);_056‍.w("./datos/data.js",[["default",["tripulantes"],function(v){tripulantes=v}]]);// palabra clave + nombre estructura datos + ubicación del archivo con los datos
 //importando un arreglo de objetos

// export const nombreFuncion = (listaParametro) =>^{ cuerpo de la función.}            
       const busquedaPorId = (paramID) => {
...
// export const nombreFuncion = (listaParametro) =>^{ cuerpo de la función.}  
       const busquedaPorSalario = (paramSalario)=>{
